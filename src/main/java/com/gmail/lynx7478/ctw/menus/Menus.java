	...
	TEAMSELECTOR(Material.NETHER_STAR, "Left click to select a team.", "Team Selector", new ItemFunction()
			{
				...
				public void onItemClick(CTWPlayer p, ItemStack item) 
				{
					...
					{
							new ItemBuilder(CTWTeam.RGB.getWoolColor(), ChatColor.GOLD+"Click to join team "+CTWTeam.RGB.getColoredName()+ChatColor.GOLD+"!", new ItemFunction()
							{
							...
							new ItemBuilder(CTWTeam.CMY.getWoolColor(), ChatColor.GOLD+"Click to join team "+CTWTeam.CMY.getColoredName()+ChatColor.GOLD+"!", new ItemFunction()
							{
