...
public class Loadout {
	...
	{
		return this.addItem(new ItemStack(Material.WOODEN_PICKAXE));
	}
	
	public Loadout addWoodSword()
	{
		return this.addItem(new ItemStack(Material.WOODEN_SWORD));
	}
	
	public Loadout addChestItem()
	{
		ItemStack i = ItemUtils.createNewSoulboud(Material.ENDER_EYE, 2);
