...
public enum ItemWrapper {
    ...
    SETLOBBY(Material.WHITE_WOOL, ChatColor.AQUA + "Set lobby location", ItemType.CLICK, null, new Function() {
        @Override
    ...
    LOADWORLD(Material.GRASS_BLOCK, ChatColor.AQUA+"Load game world.", ItemType.CLICK, null, new Function()
    		{
    	@Override
    	public void func(Player p, Block clickedBlock)
    	{
	...
	SETWRGB(CTWTeam.RGB.getWoolColor(), ChatColor.AQUA + "Set RGB Wool Locations", ItemType.INTERACT, Action.LEFT_CLICK_BLOCK, new Function()
			{
	...
	SETWCMY(CTWTeam.CMY.getWoolColor(), ChatColor.AQUA + "Set CMY Wool Locations", ItemType.INTERACT, Action.LEFT_CLICK_BLOCK, new Function()
	{
...
public void func(final Player p, final Block clickedBlock)
{
	...
	SETMRGB(CTWTeam.RGB.getWoolColor(), ChatColor.AQUA + "Set RGB Monument Locations", ItemType.INTERACT, Action.LEFT_CLICK_BLOCK, new Function()
	{
...
public void func(final Player p, final Block clickedBlock)
{
	...
	SETMCMY(CTWTeam.CMY.getWoolColor(), ChatColor.AQUA + "Set CMY Monument Locations", ItemType.INTERACT, Action.LEFT_CLICK_BLOCK, new Function()
	{
...
public void func(final Player p, final Block clickedBlock)
{
	...
	SETSPAWNS(Material.RED_BED, ChatColor.AQUA+"Set spawns.", ItemType.CLICK, null, new Function()
			{
	...
	SETRGBSPAWN(CTWTeam.RGB.getWoolColor(), ChatColor.AQUA+"Set RGB Spawn", ItemType.INTERACT, Action.LEFT_CLICK_BLOCK, new Function()
			{
	...
	SETCMYSPAWN(CTWTeam.CMY.getWoolColor(), ChatColor.AQUA+"Set CMY Spawn", ItemType.INTERACT, Action.LEFT_CLICK_BLOCK, new Function()
	{
